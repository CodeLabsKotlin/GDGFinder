# 10.1, 10.2, 10.3 GDGFinder :mailbox:

## Descripcion
En este proyecto se plasma todo lo aprendido en los codelabs, en cuanto al tratamiento de los datos y la informacion, asi como la navegacion entre las diferentes pantallas. Se hace uso de MaterialDesign para el apartado del estilo.
